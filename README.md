...
- **Не пушить напрямую в `master` ветку**  
...
2) **Обязательное выполнение ВСЕХ тестов перед сливанием `pull request`**  
...
4) **Осмысленные сообщения коммитов**  
