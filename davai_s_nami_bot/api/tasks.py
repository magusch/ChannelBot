...
@router.post("/new-event-from-sites/", response_model=TaskResponse,
              ...
              description="Start scraping events from the specified source sites. Sources: timepad, radario, ticketscloud, qtickets, mts, kassir, afisha, yandex, culture, cfg, vk, telegram, tripster (tripster is excluded from \"all\" and must be named explicitly).")
