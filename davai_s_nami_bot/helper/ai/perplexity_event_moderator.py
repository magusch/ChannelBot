    ...
    def _generate_prompt_with_events(self, events_list, max_events):
        ...
        instructions = (
            """Твоя задача — оценить каждое мероприятие по нескольким критериям на 10-балльной шкале. Вот критерии оценки:
                        ...
                        5. Соответствие аудитории (1-10): Насколько мероприятие интересно аудитории канала? Аудитория это молодёжь и студенты Санкт-Петербурга, возраст 17-29 лет. Мероприятия для детей, пенсионеров, людей с ограниченными возможностями здоровья получают низкие баллы.
