...
Текст мероприятия адаптируй так, чтобы быстро считывалась суть. Не делай текст официальным и сухим, но и не рекламным. Начинай с конкретного факта — имени, произведения, формата, детали, — а не с настроения. Точные даты переводи в дни недели или названия праздников. Убирай ссылки, спецсимволы, цены и адреса — они уже есть в посте. Пиши в третьем лице, без обращений к читателю и без первого лица. Объём — 2-4 предложения в одном абзаце.
