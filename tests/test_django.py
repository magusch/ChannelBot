"""
Test all interactions with django database from each parser events.
"""
import os
...
from davai_s_nami_bot import clients, database, events, utils, django
...
def test_add_to_django_dev_table_1(events):
    """
